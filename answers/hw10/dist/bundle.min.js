!function(e){function t(r){if(n[r])return n[r].exports;var i=n[r]={exports:{},id:r,loaded:!1};return e[r].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var n={};t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){function r(e){return'<div class="viewbox"><div class="preview"><a href="https://www.twitch.tv/'+e.channel.name+'" target="_blank"><img src="'+e.preview.medium+'"  onload="this.style.opacity=1"></a></div><div class="bottom"><div class="headpic"><img src="'+e.channel.logo+'" onload="this.style.opacity=1"></div><div class="intro"><div class="channel_name">'+e.channel.status+'</div><div class="host_name">'+e.channel.display_name+"</div></div></div></div>"}function i(e){a("#zh-tw").removeClass("selected"),a("#en").removeClass("selected"),a("#"+e).addClass("selected")}function o(e){a(".title").text(s.getLocalString(u.LOCAL_ID.TITLE,e)),i(e),c=e,l=0,p.empty(),p.append('<div id="first_viewbox" class="viewbox"></div>'),p.append('<div class="viewbox"></div>'),d()}var a=n(1),s=n(2),u=n(6),l=0,c="zh-tw",f=!1,p=a(".container"),d=function(){f=!0,a.ajax({method:"GET",url:"https://api.twitch.tv/kraken/streams?client_id=30vl9dbtf7whfh5ejeob3myp2gfuyo&game=League%20of%20Legends&limit=10&offset="+l+"&language="+c,success:function(e){for(var t=e.streams,n=0;n<t.length;n++)a(r(t[n])).insertBefore(a("#first_viewbox"));l+=10,f=!1},error:function(){p.append('<div class="error">Failed to Load Twitch Data.</div>')}})};a("#zh-tw").click(function(){o("zh-tw")}),a("#en").click(function(){o("en")}),a(document).ready(function(){d(),a(window).scroll(function(){a(window).scrollTop()+a(window).height()>a(document).height()-200&&(f||d())})})},function(e,t,n){var r,i;/*!
